...
def main():
    base_model = tf.keras.applications.MobileNet(input_shape=(64, 64, 3), include_top=False,
                                                   weights='imagenet')
    ...
    # model summary
    model.summary()
    model.save('./model/model-MobileNet.h5')
    ...
    plot_confusion_matrix(cm, classes=list(map_characters.values()), title='MobileNet confusion matrix')
    plt.show()
