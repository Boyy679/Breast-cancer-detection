...
def main():
    base_model = tf.keras.applications.MobileNetV2(input_shape=(64, 64, 3), include_top=False,
                                                   weights='imagenet')
    model = Sequential()
    ...
    plot_confusion_matrix(cm, classes=list(map_characters.values()), title='MobileNetV2 confusion matrix')
    plt.show()
