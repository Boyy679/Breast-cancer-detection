...
def main():
    base_model = tf.keras.applications.ResNet50(input_shape=(64, 64, 3), include_top=False,
                                                   weights='imagenet')
    model = Sequential()
    ...
    plot_confusion_matrix(cm, classes=list(map_characters.values()), title='ResNet50 confusion matrix')
    plt.show()
