...
# fit using vgg19
def main():
    base_model = tf.keras.applications.VGG19(input_shape=(64, 64, 3), include_top=False,
                                             weights='imagenet')
    ...
    model.summary()
    model.save('./model/model-VGG19.h5')
    ...
    plot_confusion_matrix(cm, classes=list(map_characters.values()), title='VGG19 confusion matrix')
    plt.show()
